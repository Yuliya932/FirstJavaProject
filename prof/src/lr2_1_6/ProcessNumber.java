...
public class ProcessNumber {
	...
	*/
    ...
    public static  double parseNumber(String str){
        ...
        System.out.println( "Число: " + number + "; экспонента: " + exp+ "; тип экспоненты: " + etype
                + "; основание системы счисления: " + base+ "; знак числа: " + sign+ "; знак экспоненты: " + esign);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Введите число и обозначение системы счисления 16:x, 8:c, 2:b ");
        String number = in.nextLine();

//        System.out.println("Введите систему счисления своего числа 2 или 10: ");
//        int base = in.nextInt();
        double binary =parseNumber(number);
