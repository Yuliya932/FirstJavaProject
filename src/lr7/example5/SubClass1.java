...
На основе суперкласса создаются два подкласса (оба на основе одного и того же суперкласса). В одном из классов появляется
...
public class SubClass1 extends SuperClass{
    ...
    public SubClass1 ( String str1,int int1 ){ //конструктор с двумя параметрами
        super(str1);
        this.int1 = int1;
    }
