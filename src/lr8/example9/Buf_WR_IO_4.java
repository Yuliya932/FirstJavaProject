...
Наиболее быстро и корректно работают буферизированные символьные
потоки, построенные на байтовых потоках
*/
...
// Создание потоков для чтения и записи с нужной кодировкой
            ...
            bw = new BufferedWriter(
                    new OutputStreamWriter(
                            new FileOutputStream("C:/Users/DearUser3/IdeaProjects/FirstJavaProject/MyFile2.txt"),"cp1251"));
