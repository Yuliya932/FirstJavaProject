...
// Чтение и вывод данных из созданного файла
    ...
    /*Классы DataInputStream и DataOutputStream при работе с числовыми
    типами данных и с данными булевского типа более предпочтительны по
    сравнению с другими классами библиотеки ввода/вывода java, но при работе с
        обычными строками они не применяются. Например, при попытке считать строку
        типа String среда выдаст предупреждающую запись в виде:
