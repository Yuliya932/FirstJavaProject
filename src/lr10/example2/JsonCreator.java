/*создаем JSONObject, который представляет нашу библиотеку, и JSONArray, который содержит объекты JSONObject, представляющие каждую книгу. Мы добавляем две книги в наш массив, а затем добавляем этот массив в объект JSONObject, который представляет всю библиотеку.
